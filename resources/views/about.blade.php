                ...
                <div class="about__container sample__container">
                        ...
                        <div class="about__mission-right">
                            ...
                            <div class="about__mission-stark">
                                ...
                                <div class="col">
                                    ...
                                    <span>(Technology) Технологии</span>                                        
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <span>(Key Value) Ключевая ценность</span>                                        
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="about__stats">
                        ...
                        <div class="about__stats-right">
                            <ul>
                                <li>
                                    <h3>S - (Service) Сервис:</h3>
                                    <p>{{$page->s}}</p>
                                </li>
                                <li>
                                    <h3>T - (Technology) Технологии:</h3>
                                    <p>{{$page->t}}</p>
                                </li>
                                <li>
                                    <h3>A - (Attention) Аттенция:</h3>
                                    <p>{{$page->a}}</p>
                                </li>
                                <li>
                                    <h3>R - (Respect) Респект:</h3>
                                    <p>{{$page->r}}</p>
                                </li>
                                <li>
                                    <h3>K - (Key Value) Ключевая ценность:</h3>
                                    <p>{{$page->k}}</p>
                                </li>
                            </ul>
                        </div>
